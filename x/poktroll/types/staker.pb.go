...
// source: poktroll/poktroll/staker.proto
...
func (*Staker) Descriptor() ([]byte, []int) {
	return fileDescriptor_9e045ea4463dc8ee, []int{0}
}
...
func (m *Staker) GetCoinsStaked() string {
	if m != nil {
...
func init() {
	proto.RegisterType((*Staker)(nil), "poktroll.poktroll.Staker")
}

func init() { proto.RegisterFile("poktroll/poktroll/staker.proto", fileDescriptor_9e045ea4463dc8ee) }

var fileDescriptor_9e045ea4463dc8ee = []byte{
	// 142 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Staker) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CoinsStaked) > 0 {
		...
		i = encodeVarintStaker(dAtA, i, uint64(len(m.CoinsStaked)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Addr) > 0 {
		i -= len(m.Addr)
		copy(dAtA[i:], m.Addr)
		i = encodeVarintStaker(dAtA, i, uint64(len(m.Addr)))
		i--
		dAtA[i] = 0xa
	}
