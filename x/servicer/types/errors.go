...
var (
	...
	ErrInvalidProof                 = sdkerrors.Register(ModuleName, 14, "Failed to validate proof")
	ErrInvalidPath                  = sdkerrors.Register(ModuleName, 15, "Invalid path")
	ErrUnsupportedMultiSig          = sdkerrors.Register(ModuleName, 16, "Unsupported multi-sig")
)
