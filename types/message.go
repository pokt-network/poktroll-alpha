...
func (msg *MessageSend) GetActorType() ActorType {
	return ActorType_ACTOR_TYPE_UNSPECIFIED // there's no actor type for message send, so return zero to allow fee retrieval
}
func (msg *MessageChangeParameter) GetActorType() ActorType {
