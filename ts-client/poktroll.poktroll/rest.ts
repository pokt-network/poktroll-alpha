...
export interface PoktrollMsgUnstakeResponse {
  /** TODO: Need to return success/error codes */
  success?: boolean;
}
...
export interface PoktrollQueryServicersResponse {
  servicers?: PoktrollServicer[];
...
export interface PoktrollServicer {
  stake_info?: PoktrollStakeInfo;
  servicer_params?: PoktrollServicerParams;
}

export type PoktrollServicerParams = object;

export interface PoktrollStakeInfo {
...
/**
 * @title poktroll/poktroll/actor.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name QueryServicers
   * @summary Queries for all staked Servicers
   * @request GET:/poktroll/poktroll/servicers
   */
  queryServicers = (
    query?: {
    ...
    this.request<PoktrollQueryServicersResponse, RpcStatus>({
      path: `/poktroll/poktroll/servicers`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
