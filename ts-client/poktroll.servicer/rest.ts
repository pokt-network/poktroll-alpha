 ...
 */
export type ServicerParams = object;

export interface ServicerQueryAllServicersResponse {
...
export interface ServicerQueryGetServicersResponse {
  servicers?: ServicerServicers;
}
...
/**
 * @title poktroll/servicer/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/poktroll/servicer/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<ServicerQueryParamsResponse, RpcStatus>({
      path: `/poktroll/servicer/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   *
   * @tags Query
   * @name QueryServicersAll
   * @request GET:/poktroll/servicer/servicers
   */
  queryServicersAll = (
    query?: {
    ...
    this.request<ServicerQueryAllServicersResponse, RpcStatus>({
      path: `/poktroll/servicer/servicers`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
