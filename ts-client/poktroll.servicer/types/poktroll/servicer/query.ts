...
export const QueryGetServicersRequest = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.inaddressdex = reader.string();
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromPartial<I extends Exact<DeepPartial<QueryGetServicersRequest>, I>>(
    object: I
  ): QueryGetServicersRequest {
    const message = createBaseQueryGetServicersRequest();
...
export const QueryGetServicersResponse = {
  ...
  fromJSON(object: any): QueryGetServicersResponse {
    return {
      servicers: isSet(object.servicers)
        ? Servicers.fromJSON(object.servicers)
        : undefined,
    };
  },
  ...
  toJSON(message: QueryGetServicersResponse): unknown {
    ...
    message.servicers !== undefined &&
      (obj.servicers = message.servicers
        ? Servicers.toJSON(message.servicers)
        : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<QueryGetServicersResponse>, I>>(
    object: I
  ): QueryGetServicersResponse {
    const message = createBaseQueryGetServicersResponse();
    message.servicers =
      object.servicers !== undefined && object.servicers !== null
...
export const QueryAllServicersRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAllServicersRequest>, I>>(
    object: I
  ): QueryAllServicersRequest {
    const message = createBaseQueryAllServicersRequest();
    message.pagination =
...
export const QueryAllServicersResponse = {
  ...
  fromJSON(object: any): QueryAllServicersResponse {
    return {
      servicers: Array.isArray(object?.servicers)
        ? object.servicers.map((e: any) => Servicers.fromJSON(e))
        : [],
      pagination: isSet(object.pagination)
  ...
  toJSON(message: QueryAllServicersResponse): unknown {
    ...
    if (message.servicers) {
      obj.servicers = message.servicers.map((e) =>
        e ? Servicers.toJSON(e) : undefined
      );
    } else {
      obj.servicers = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAllServicersResponse>, I>>(
    object: I
  ): QueryAllServicersResponse {
    const message = createBaseQueryAllServicersResponse();
    message.servicers =
      object.servicers?.map((e) => Servicers.fromPartial(e)) || [];
    message.pagination =
      object.pagination !== undefined && object.pagination !== null
...
export interface Query {
  ...
  Servicers(
    request: QueryGetServicersRequest
  ): Promise<QueryGetServicersResponse>;
  ServicersAll(
    request: QueryAllServicersRequest
  ): Promise<QueryAllServicersResponse>;
}
...
export class QueryClientImpl implements Query {
  ...
  Servicers(
    ...
    const promise = this.rpc.request(
      "poktroll.servicer.Query",
      "Servicers",
      data
    );
    return promise.then((data) =>
      QueryGetServicersResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  ServicersAll(
    ...
    return promise.then((data) =>
      QueryAllServicersResponse.decode(new _m0.Reader(data))
    );
  }
}
